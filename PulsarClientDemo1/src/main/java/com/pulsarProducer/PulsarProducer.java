...
public class PulsarProducer {
	...
	private PulsarClient initClient() throws PulsarClientException{
		//PulsarClient client = PulsarClient.builder().serviceUrl(mServiceUrl).build();
		return PulsarClient.builder().serviceUrl(mServiceUrl).build();  // pulsor client initializatio // pulsor client initialization
	}
